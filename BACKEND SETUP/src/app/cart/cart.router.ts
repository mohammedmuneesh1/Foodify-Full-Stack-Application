...
import { ADD_TO_CART, GET_CART, REMOVE_CART_ITEM, UPDATE_CART_ITEM_QUANTITY } from './cart.controller';
...
//------------------------ GET_FULL_CART ------------------------
router.route('/').get(authMiddleware,tryCatch(GET_CART));
//------------------------ UPDATE_CART_QUANTITY ------------------------
router.route('/item/:cartItemId').patch(authMiddleware,tryCatch(UPDATE_CART_ITEM_QUANTITY));
//------------------------ DELETE_CART_QUANTITY ------------------------
router.route('/item/:cartItemId').delete(authMiddleware,tryCatch(REMOVE_CART_ITEM));
